...
public class Assignment4 {
    ...
    // function to calculate anniversary date
    public static LocalDate getAnniversaryDate(LocalDate signupDate, LocalDate currentDate) {
    ...
    // function to calculate KYC date range
    public static String getKycRange(LocalDate signupDate, LocalDate currentDate) {
        LocalDate anniversaryDate = getAnniversaryDate(signupDate, currentDate);
        LocalDate startDate = anniversaryDate.minusDays(30);
        LocalDate endDate = anniversaryDate.plusDays(30);
        if (endDate.isBefore(currentDate)) {
            return "No range";
        } else {
            startDate = (startDate.isBefore(anniversaryDate.minusYears(1))) ? anniversaryDate.minusYears(1) : startDate;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.println(getKycRange(signupDate, currentDate));
        }
        sc.close();
    }
}
